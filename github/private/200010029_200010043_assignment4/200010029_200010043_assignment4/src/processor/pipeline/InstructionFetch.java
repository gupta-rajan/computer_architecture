...
public class InstructionFetch {
	...
	public void performIF()
	{
		...
		{
			/*if(EX_IF_Latch.getIS_enable()||true)
			{
			...
			//System.out.println("FirstPC "+currentPC);
			...
			//System.out.println("stalls "+containingProcessor.getStalls());
			//System.out.println("wrong path "+containingProcessor.getWrong_input());
		}
	}
}
